using Dapper;
using Multishop.DiscountApi.Context;
...
namespace Multishop.DiscountApi.Services
{
    public class DiscountService : IDiscountService
    {
        ...
        public async Task<List<ResultDiscountCouponDto>> GetDiscountCouponListAsync()
        {
            ...
            using(var connection = _dapperContext.CreateConnection())
            {
                return (await connection.QueryAsync<ResultDiscountCouponDto>(query)).ToList();
            }
        }

        public async Task UpdateDiscountCouponAsync(UpdatetDiscountCouponDto updateCouponDto)
        {
